        ...
        <div
            ...
            <div
                ...
                <button
                    ...
                    aria-label="Close">
                    <span className="text-[#4C0002] opacity-0 group-hover:opacity-100 text-xs">
                        ×
                    </span>
                </button>
                <button
                    ...
                    aria-label="Minimize">
                    <span className="text-[#9A6B00] opacity-0 group-hover:opacity-100 text-xs">
                        −
                    </span>
                </button>
                <button
                    ...
                    <span className="text-[#0B6309] opacity-0 group-hover:opacity-100 text-xs">
                        +
                    </span>
                </button>
            </div>
